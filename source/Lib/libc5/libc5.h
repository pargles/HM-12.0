...
void	    GetNamesC(char**Nf);
void	    ExplicitAttC(char**Nf);
...
void	    ImplicitAttC(char**Nf);
void	    ReadDefinitionC(char**f);
void	    Append(char c);
...
void	    GetDataC(char **Df, Boolean Train, Boolean AllowUnknownClass);
DataRec	    GetDataRecC(char **Df, Boolean Train);
CaseNo	    CountDataC(char *Df);
